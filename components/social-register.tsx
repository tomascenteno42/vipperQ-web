...
type SocialMediaRegisterFormProps = {
  // eslint-disable-next-line unused-imports/no-unused-vars
  register: (payload: FormData) => void;
  state: { path: string; message: string };
};

export function SocialMediaRegisterForm({
  register,
  state,
}: SocialMediaRegisterFormProps) {
  return (
      ...
      <div className="mx-auto max-w-screen-xl px-4 py-8 lg:grid lg:grid-cols-12 lg:gap-20 lg:py-16">
        ...
        <div className="mx-auto w-full rounded-lg bg-white shadow dark:bg-gray-800 sm:max-w-lg md:mt-0 lg:col-span-7 xl:col-span-6 xl:p-0">
          <div className="space-y-4 p-6 sm:p-8 lg:space-y-6">
            ...
            <form className="space-y-4 lg:space-y-6" action={register}>
              <div className="grid grid-cols-1 gap-2">
                ...
                <TextInput
                  ...
                  required
                  type="email"
                  color={state?.path === "email" ? "failure" : undefined}
                  helperText={state.path === "email" && state?.message}
                />
              </div>
              <div className="grid grid-cols-1 gap-2">
                ...
                <TextInput
                  ...
                  required
                  type="password"
                  color={state?.message ? "failure" : undefined}
                  helperText={state.path === "password" && state?.message}
                />
              </div>
...
function RegisterAccountButton() {
  ...
  return (
    <Button type="submit" className="w-full" isProcessing={pending}>
      Create an account
    </Button>
  );
}
